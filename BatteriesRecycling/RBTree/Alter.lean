...
protected theorem _root_.RBTree.RBNode.Balanced.zoom : t.Balanced c n → path.Balanced c₀ n₀ c n →
...
theorem _root_.RBTree.RBNode.cmpEq.RootOrdered_congr
...
theorem _root_.RBTree.RBNode.Ordered.zoom' {t : RBNode α} {path : Path α}
...
theorem _root_.RBTree.RBNode.Ordered.zoom {t : RBNode α}
