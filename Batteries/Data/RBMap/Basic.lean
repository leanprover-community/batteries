...
This module is deprecated: use `Std.TreeMap` from the standard library instead.
`Std.TreeMap` is a mostly drop-in replacement (notably, there is no `ToStream` instance yet),
and has more complete and consistent API.
...
/-- Fold a function on the values from left to right (in increasing order). -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), specialize]
def foldl (f : σ → α → σ) : (init : σ) → RBNode.Stream α → σ
  | b, nil           => b
  | b, cons v r tail => foldl f (r.foldl f (f b v)) tail

/-- Fold a function on the values from right to left (in decreasing order). -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), specialize]
def foldr (f : α → σ → σ) : RBNode.Stream α → (init : σ) → σ
  | nil,           b => b
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), reducible]
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), nolint docBlame]
scoped instance Slow.instDecidableEMem [DecidableEq α] {t : RBNode α} :
    Decidable (EMem x t) := inferInstanceAs (Decidable (Any ..))

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), nolint docBlame]
scoped instance Slow.instDecidableMemP {t : RBNode α} :
    Decidable (MemP cut t) := inferInstanceAs (Decidable (Any ..))

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), nolint docBlame]
scoped instance Slow.instDecidableMem {t : RBNode α} :
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), specialize]
def all₂ (R : α → β → Bool) (t₁ : RBNode α) (t₂ : RBNode β) : Bool :=
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def balance1 : RBNode α → α → RBNode α → RBNode α
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def balance2 : RBNode α → α → RBNode α → RBNode α
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), specialize]
def ins (cmp : α → α → Ordering) (x : α) : RBNode α → RBNode α
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), specialize]
def insert (cmp : α → α → Ordering) (t : RBNode α) (v : α) : RBNode α :=
  match isRed t with
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), specialize]
def find? (cut : α → Ordering) : RBNode α → Option α
  | nil => none
  | node _ a y b =>
    match cut y with
    | .lt => find? cut a
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), specialize]
def map (f : α → β) : RBNode α → RBNode β
  | nil => nil
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def Path.insertNew (path : Path α) (v : α) : RBNode α :=
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), specialize]
def modify (cut : α → Ordering) (f : α → α) (t : RBNode α) : RBNode α :=
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), nolint docBlame]
scoped instance Slow.instDecidableOrdered (cmp) [Std.TransCmp cmp] :
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def isEmpty : RBSet α cmp → Bool
  | ⟨nil, _⟩ => true
  | _        => false

/-- `O(n)`. Convert the tree to a list in ascending order. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def toList (t : RBSet α cmp) : List α := t.1.toList

/-- `O(log n)`. Returns the entry `a` such that `a ≤ k` for all keys in the RBSet. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
protected def min? (t : RBSet α cmp) : Option α := t.1.min?

/-- `O(log n)`. Returns the entry `a` such that `a ≥ k` for all keys in the RBSet. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
protected def max? (t : RBSet α cmp) : Option α := t.1.max?
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def erase (t : RBSet α cmp) (cut : α → Ordering) : RBSet α cmp :=
  ⟨t.1.erase cut, t.2.erase⟩

/-- `O(log n)`. Find an element in the tree using a cut function. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def findP? (t : RBSet α cmp) (cut : α → Ordering) : Option α := t.1.find? cut

/-- `O(log n)`. Returns an element in the tree equivalent to `x` if one exists. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def find? (t : RBSet α cmp) (x : α) : Option α := t.1.find? (cmp x)

/-- `O(log n)`. Find an element in the tree, or return a default value `v₀`. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def findPD (t : RBSet α cmp) (cut : α → Ordering) (v₀ : α) : α := (t.findP? cut).getD v₀
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def upperBound? (t : RBSet α cmp) (k : α) : Option α := t.upperBoundP? (cmp k)
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def all₂ (R : α → β → Bool) (t₁ : RBSet α cmpα) (t₂ : RBSet β cmpβ) : Bool :=
  t₁.1.all₂ R t₂.1
...
-- The real `O(log n)` instances are defined in `Data.RBMap.Lemmas`.
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), nolint docBlame]
scoped instance Slow.instDecidableEMem [DecidableEq α] {t : RBSet α cmp} :
    Decidable (EMem x t) := inferInstanceAs (Decidable (Any ..))

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), nolint docBlame]
scoped instance Slow.instDecidableMemP {t : RBSet α cmp} :
    Decidable (MemP cut t) := inferInstanceAs (Decidable (Any ..))

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), nolint docBlame]
scoped instance Slow.instDecidableMem {t : RBSet α cmp} :
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def min! [Inhabited α] (t : RBSet α cmp) : α := t.min?.getD (panic! "tree is empty")

/-- `O(log n)`. Returns the maximum element of the tree, or panics if the tree is empty. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def max! [Inhabited α] (t : RBSet α cmp) : α := t.max?.getD (panic! "tree is empty")

/--
`O(log n)`. Attempts to find the value with key `k : α` in `t` and panics if there is no such key.
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def findP! [Inhabited α] (t : RBSet α cmp) (cut : α → Ordering) : α :=
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def find! [Inhabited α] (t : RBSet α cmp) (k : α) : α :=
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def mkRBMap (α : Type u) (β : Type v) (cmp : α → α → Ordering) : RBMap α β cmp :=
  mkRBSet ..
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def RBMap.single (k : α) (v : β) : RBMap α β cmp := RBSet.single (k, v)
...
/-- `O(n)`. Fold a function on the values from left to right (in increasing order). -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def foldl (f : σ → α → β → σ) : (init : σ) → RBMap α β cmp → σ
  | b, ⟨t, _⟩ => t.foldl (fun s (a, b) => f s a b) b

/-- `O(n)`. Fold a function on the values from right to left (in decreasing order). -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def foldr (f : α → β → σ → σ) : (init : σ) → RBMap α β cmp → σ
  | b, ⟨t, _⟩ => t.foldr (fun (a, b) s => f a b s) b

/-- `O(n)`. Fold a monadic function on the values from left to right (in increasing order). -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def foldlM [Monad m] (f : σ → α → β → m σ) : (init : σ) → RBMap α β cmp → m σ
  | b, ⟨t, _⟩ => t.foldlM (fun s (a, b) => f s a b) b

/-- `O(n)`. Run monadic function `f` on each element of the tree (in increasing order). -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def forM [Monad m] (f : α → β → m PUnit) (t : RBMap α β cmp) : m PUnit :=
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def keysArray (t : RBMap α β cmp) : Array α :=
  t.1.foldl (init := #[]) (·.push ·.1)

/-- `O(n)`. Constructs the list of keys of the map. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def keysList (t : RBMap α β cmp) : List α :=
  t.1.foldr (init := []) (·.1 :: ·)
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def keys (t : RBMap α β cmp) : Keys α β cmp := t

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline, inherit_doc keysArray]
def Keys.toArray := @keysArray

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline, inherit_doc keysList]
def Keys.toList := @keysList
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def valuesArray (t : RBMap α β cmp) : Array β :=
  t.1.foldl (init := #[]) (·.push ·.2)

/-- `O(n)`. Constructs the list of values of the map. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def valuesList (t : RBMap α β cmp) : List β :=
  t.1.foldr (init := []) (·.2 :: ·)
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def values (t : RBMap α β cmp) : Values α β cmp := t

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline, inherit_doc valuesArray]
def Values.toArray := @valuesArray

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline, inherit_doc valuesList]
def Values.toList := @valuesList
...
/-- `O(1)`. Is the tree empty? -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def isEmpty : RBMap α β cmp → Bool := RBSet.isEmpty

/-- `O(n)`. Convert the tree to a list in ascending order. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def toList : RBMap α β cmp → List (α × β) := RBSet.toList

/-- `O(log n)`. Returns the key-value pair `(a, b)` such that `a ≤ k` for all keys in the RBMap. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
protected def min? : RBMap α β cmp → Option (α × β) := RBSet.min?

/-- `O(log n)`. Returns the key-value pair `(a, b)` such that `a ≥ k` for all keys in the RBMap. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
protected def max? : RBMap α β cmp → Option (α × β) := RBSet.max?
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def erase (t : RBMap α β cmp) (k : α) : RBMap α β cmp := RBSet.erase t (cmp k ·.1)

/-- `O(n log n)`. Build a tree from an unsorted list by inserting them one at a time. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def ofList (l : List (α × β)) (cmp : α → α → Ordering) : RBMap α β cmp :=
  RBSet.ofList l _

/-- `O(n log n)`. Build a tree from an unsorted array by inserting them one at a time. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def ofArray (l : Array (α × β)) (cmp : α → α → Ordering) : RBMap α β cmp :=
  RBSet.ofArray l _
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def find? (t : RBMap α β cmp) (k : α) : Option β := t.findEntry? k |>.map (·.2)

/-- `O(log n)`. Find the value corresponding to key `k`, or return `v₀` if it is not in the map. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def findD (t : RBMap α β cmp) (k : α) (v₀ : β) : β := (t.find? k).getD v₀
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def lowerBound? (t : RBMap α β cmp) (k : α) : Option (α × β) :=
   RBSet.lowerBoundP? t (cmp k ·.1)

/-- `O(log n)`. Returns true if the given key `a` is in the RBMap. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def contains (t : RBMap α β cmp) (a : α) : Bool := (t.findEntry? a).isSome

/-- `O(n)`. Returns true if the given predicate is true for all items in the RBMap. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def all (t : RBMap α β cmp) (p : α → β → Bool) : Bool := RBSet.all t fun (a, b) => p a b

/-- `O(n)`. Returns true if the given predicate is true for any item in the RBMap. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def any (t : RBMap α β cmp) (p : α → β → Bool) : Bool := RBSet.any t fun (a, b) => p a b
...
-/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def all₂ (R : α × β → γ × δ → Bool) (t₁ : RBMap α β cmpα) (t₂ : RBMap γ δ cmpγ) : Bool :=
  RBSet.all₂ R t₁ t₂

/-- Asserts that `t₁` and `t₂` have the same set of keys (up to equality). -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def eqKeys (t₁ : RBMap α β cmp) (t₂ : RBMap α γ cmp) : Bool :=
  t₁.all₂ (cmp ·.1 ·.1 = .eq) t₂
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def min! [Inhabited α] [Inhabited β] : RBMap α β cmp → α × β := RBSet.min!

/-- `O(log n)`. Returns the maximum element of the map, or panics if the map is empty. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def max! [Inhabited α] [Inhabited β] : RBMap α β cmp → α × β := RBSet.max!

/-- Attempts to find the value with key `k : α` in `t` and panics if there is no such key. -/
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inline]
def find! [Inhabited β] (t : RBMap α β cmp) (k : α) : β :=
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), inherit_doc RBMap.ofList]
