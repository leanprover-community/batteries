...
theorem min?_reverse (t : RBNode α) : t.reverse.min? = t.max? := by
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem max?_reverse (t : RBNode α) : t.reverse.max? = t.min? := by
  rw [← min?_reverse, reverse_reverse]

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem mem_nil {x} : ¬x ∈ (.nil : RBNode α) := by simp [Membership.mem, EMem]
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem mem_node {y c a x b} :
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem toList_nil : (.nil : RBNode α).toList = [] := rfl

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem toList_node : (.node c a x b : RBNode α).toList = a.toList ++ x :: b.toList := by
  rw [toList, foldr, foldr_cons]; rfl

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem toList_reverse (t : RBNode α) : t.reverse.toList = t.toList.reverse := by
  induction t <;> simp [*]

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem mem_toList {t : RBNode α} : x ∈ t.toList ↔ x ∈ t := by
  induction t <;> simp [*, or_left_comm]

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem mem_reverse {t : RBNode α} : a ∈ t.reverse ↔ a ∈ t := by rw [← mem_toList]; simp
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem toList_nil : (.nil : RBNode.Stream α).toList = [] := rfl
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem toStream_toList {t : RBNode α} : t.toStream.toList = t.toList := by
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem setBlack_toList {t : RBNode α} : t.setBlack.toList = t.toList := by
  cases t <;> simp [setBlack]

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem setRed_toList {t : RBNode α} : t.setRed.toList = t.toList := by
  cases t <;> simp [setRed]
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem reverse_size (t : RBNode α) : t.reverse.size = t.size := by simp [size_eq]

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem Any_reverse {t : RBNode α} : t.reverse.Any p ↔ t.Any p := by simp [Any_def]

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem memP_reverse {t : RBNode α} : MemP cut t.reverse ↔ MemP (cut · |>.swap) t := by
  simp [MemP]
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem find?_reverse (t : RBNode α) (cut : α → Ordering) :
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem upperBound?_reverse (t : RBNode α) (cut ub) :
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem lowerBound?_reverse (t : RBNode α) (cut lb) :
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem fill_toList {p : Path α} : (p.fill t).toList = p.withList t.toList := by
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem ins_toList {p : Path α} : (p.ins t).toList = p.withList t.toList := by
  match p with
  | .root | .left red .. | .right red .. | .left black .. | .right black .. =>
    simp [ins, ins_toList]

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem insertNew_toList {p : Path α} : (p.insertNew v).toList = p.withList [v] := by
  simp [insertNew]
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem val_toList {t : RBSet α cmp} : t.1.toList = t.toList := rfl

@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem mkRBSet_eq : mkRBSet α cmp = ∅ := rfl
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem empty_eq : @RBSet.empty α cmp = ∅ := rfl
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem default_eq : (default : RBSet α cmp) = ∅ := rfl
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem empty_toList : toList (∅ : RBSet α cmp) = [] := rfl
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem single_toList : toList (single a : RBSet α cmp) = [a] := rfl
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem toStream_toList {t : RBSet α cmp} : (Std.toStream t).toList = t.toList := by
  simp [toStream_eq]
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem contains_iff [Std.TransCmp (α := α) cmp] {t : RBSet α cmp} :
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem mkRBSet_eq : mkRBMap α β cmp = ∅ := rfl
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem empty_eq : @RBMap.empty α β cmp = ∅ := rfl
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem default_eq : (default : RBMap α β cmp) = ∅ := rfl
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem empty_toList : toList (∅ : RBMap α β cmp) = [] := rfl
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem single_toList : toList (single a b : RBMap α β cmp) = [(a, b)] := rfl
...
@[deprecated "Use `Std.TreeMap` instead." (since := "2026-05-05"), simp]
theorem toStream_toList {t : RBMap α β cmp} : (Std.toStream t).toList = t.toList :=
