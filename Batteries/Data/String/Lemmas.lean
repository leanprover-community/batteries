...
protected theorem not_lt_antisymm {s₁ s₂ : String} (h₁ : ¬s₁ < s₂) (h₂ : ¬s₂ < s₁) : s₁ = s₂ :=
  String.le_antisymm (by simpa using h₂) (by simpa using h₁)

@[deprecated (since := "2024-12-14")] alias lt_antisymm := String.not_lt_antisymm

instance : Batteries.TransOrd String := .compareOfLessAndEq
  String.lt_irrefl String.lt_trans String.not_lt_antisymm
