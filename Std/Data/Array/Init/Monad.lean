...
Also lemmas about pure functions which are proved in terms of the monadic functions.
We would like to give independent proofs of these that do not rely on `SatisfiesM`.
-/
