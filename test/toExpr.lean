...
-- We don't turn this on by default, as it prints a lot to stdout during the tests,
-- and `#guard_msgs` can't capture messages generated by `deriving`.
